...
function fontclass(part){
    let cs = document.getElementById("notice").className;
    if(part == "1"){
        plus_cs = "section";
        document.getElementById("notice").className = plus_cs;
    }
    else{
        if(part == "2"){
            plus_cs = "font_view2";
            document.getElementById("notice").classList.remove("font_view3");
        }
        else if(part == "3"){
            plus_cs = "font_view3";
            document.getElementById("notice").classList.remove("font_view2");
        }
        document.getElementById("notice").className += " " + plus_cs;
    }
};
