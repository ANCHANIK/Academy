...
function fontclass(part){
    let cs = document.getElementById("new_pv").className;
    if(part == "1"){
        plus_cs = "section";
        document.getElementById("new_pv").className = plus_cs;
    }
    else{
        if(part == "2"){
            plus_cs = "font_view2";
            document.getElementById("new_pv").classList.remove("font_view3");
        }
        else if(part == "3"){
            plus_cs = "font_view3";
            document.getElementById("new_pv").classList.remove("font_view2");
        }
        document.getElementById("new_pv").className += " " + plus_cs;
    }
};
