export let agrees = function(){
    ...
    // console.log(agreeck1,agreeck2,agreeck3)
    if(agreeck1 != "Y"){
        alert("이용약관에 동의해 주세요");
    }
    else if(agreeck2 != "Y"){
        ...
        location.href = 'http://cksdlr7446.dothome.co.kr/es/index16.html' + "?m_terms=" + agreeck1 + "&m_email=" + agreeck2 + "&m_sms=" + agreeck3;
    }
}
